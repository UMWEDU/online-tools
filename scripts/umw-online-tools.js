jQuery( function() {
	...
	function do_umw_online_tools_resize() {
		if ( document.querySelectorAll( '.mega-menu-toggle' ).length >= 1 && jQuery( '.mega-menu-toggle' ).is( ':visible' ) ) {
			...
			jQuery( '.header-widget-area .mega-menu-wrap > ul.mega-menu' ).append( '<li class="mega-menu-item mega-menu-item-has-children mega-menu-item-umw-online-tools"><a href="#">Tools</a><ul class="mega-sub-menu"><li></li></ul></li>' );
